...
class User_info(db.Model):
    ...
    tickets = db.relationship("Ticket",cascade="all,delete",backref="user_info",lazy=True) #user can access all his tickets
...
class Theatre(db.Model):
    ...
    shows = db.relationship("Shows",cascade="all,delete",backref="Theatre",lazy=True) #theatre can access all his shows
